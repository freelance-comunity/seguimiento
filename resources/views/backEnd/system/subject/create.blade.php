@extends('backLayout.app') @section('title') Crear Nueva Asignatura @stop @section('content')
<hr/>
<div class="box">
  <div class="box-header">
    <h3 class="box-title">Crear Nueva Asignatura</h3>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    {!! Form::open(['url' => 'system/subject', 'class' => 'form-horizontal']) !!}
