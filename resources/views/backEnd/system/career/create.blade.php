@extends('backLayout.app') @section('title') Crear Nueva Carrera @stop @section('content')
<hr/>
<div class="box">
  <div class="box-header">
    <h3 class="box-title">Crear Nueva Carrera</h3>
  </div>
  <!-- /.box-header -->
  <div class="box-body">
    {!! Form::open(['url' => 'system/career', 'class' => 'form-horizontal']) !!}
