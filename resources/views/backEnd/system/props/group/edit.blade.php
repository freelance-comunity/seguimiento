@extends('backLayout.app') @section('title') Editar Grupo @stop @section('content')
<hr/>
<div class="box">
  ...
  <!-- /.box-header -->
  <div class="box-body">
    {!! Form::model($group, [ 'method' => 'PATCH', 'url' => ['system/props/group', $group->id], 'class' => 'form-horizontal' ]) !!}
